...
`;var Ni=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,We=(o,e,t,i)=>{for(var n=i>1?void 0:i?Di(e,t):e,s=o.length-1,r;s>=0;s--)(r=o[s])&&(n=(i?r(e,t,n):r(n))||n);return i&&n&&Ni(e,t,n),n};let ae=class extends _t{constructor(){super(),this.bookTitle="",this.analyticsCategories=F,this.analyticsActions=V,this.identifier=""}clickHandler(){this.dispatchEvent(new CustomEvent("bookTitleBar",{detail:{event:{category:this.analyticsCategories.bookReaderHeader,action:this.analyticsActions.titleBar}}}))}render(){return d`
      <a
        class="embed-link"
...
`;class Wi extends x{static get styles(){return c`
  ...
  `;At([u({type:String})],me.prototype,"iconClass",2);me=At([B("info-icon")],me);var Gi=Object.defineProperty,qi=Object.getOwnPropertyDescriptor,je=(o,e,t,i)=>{for(var n=i>1?void 0:i?qi(e,t):e,s=o.length-1,r;s>=0;s--)(r=o[s])&&(n=(i?r(e,t,n):r(n))||n);return i&&n&&Gi(e,t,n),n};let ce=class extends x{constructor(){super(...arguments),this.secondsLeftOnLoan=0,this.displayTime=!1}get minutesLeftOnLoan(){const o=Math.ceil(Math.round(this.secondsLeftOnLoan)/60);return o<10?`0:0${o}`:o===60?"1:00":`0:${o}`}get remainingTime(){const o="minute",e=this.minutesLeftOnLoan;return e!=="1"?`${e} ${o}s`:`${e} ${o}`}render(){const o=this.displayTime?"view":"hide";return d`
      <button
        id="timer-counter"
        class=${o}
