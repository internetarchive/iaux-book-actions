      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?g`<div class="logo-icon">${si}</div>`:b}
...
>
  ...
  />
    ...
    `}get renderPrimaryActions(){return this.primaryActions.length===0?b:(this.dropdownState==="close"&&(this.primaryColor=this.primaryActions[0].className),this.primaryActions.length===1?this.initialActionTemplate:g`
    ...
    `)}get renderSecondaryActions(){return this.secondaryActions.length?this.secondaryActions.map(e=>this.renderActionButton(e)):b}renderActionLink(e,t=!1){return g`<span class="${this.getDeviceType} ${e.className}">
      <a
