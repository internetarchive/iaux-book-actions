...
const primaryButtonFillColorRGB = css`var(--primaryCTAFillRGB, 25, 72, 128)`;
...
const dangerButtonFillColorRGB = css`var(--primaryErrorCTAFillRGB, 229, 28, 38)`;
const dangerButtonBorderColor = css`var(--primaryErrorCTABorder, #d43f3a)`;

const darkButtonFillColor = css`var(--secondaryCTAFill, #333)`;
const darkButtonFillColorRGB = css`var(--secondaryCTAFillRGB, 51, 51, 51)`;
...
const buttonBaseStyle: CSSResult = css`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${whiteColor};
