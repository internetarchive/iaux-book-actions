const Tt=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerpolicy&&(s.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?s.credentials="include":n.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}};Tt();/**
 * @license
...
`;let ke=class extends _{constructor(){super(...arguments),this.config=new z}render(){return p`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?p`<div class="logo-icon">${si}</div>`:m}
    ...
    `}};k([te({type:Object})],ke.prototype,"config",void 0);ke=k([Ie("modal-template")],ke);function ai(o,e,t){var i=t||{},n=i.noTrailing,s=n===void 0?!1:n,r=i.noLeading,l=r===void 0?!1:r,a=i.debounceMode,c=a===void 0?void 0:a,h,f=!1,w=0;function y(){h&&clearTimeout(h)}function C(N){var D=N||{},S=D.upcomingOnly,ge=S===void 0?!1:S;y(),f=!ge}function ie(){for(var N=arguments.length,D=new Array(N),S=0;S<N;S++)D[S]=arguments[S];var ge=this,Me=Date.now()-w;if(f)return;function ne(){w=Date.now(),e.apply(ge,D)}function Oe(){h=void 0}!l&&c&&!h&&ne(),y(),c===void 0&&Me>o?l?(w=Date.now(),s||(h=setTimeout(c?Oe:ne,o))):ne():s!==!0&&(h=setTimeout(c?Oe:ne,c===void 0?o-Me:o))}return ie.cancel=C,ie}var x;(function(o){o.Open="open",o.Closed="closed"})(x||(x={}));class li{constructor(e){this.windowResizeThrottler=ai(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case x.Open:this.startResizeListener(),this.stopDocumentScroll();break;case x.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let j=class extends _{constructor(){super(...arguments),this.mode=x.Closed,this.hostBridge=new li(this),this.modal=new ii(this),this.closeOnBackdropClick=!0}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return p`
      <div class="container">
...
`;const H=d`var(--white, #fff)`,et=d`var(--primaryBGColor, #000)`,Ti=d`var(--iaBookActionsDropdownBGColor, #2d2d2d)`;var Ei=d`
  :host {
    display: inline-flex;
    height: 3.5rem;
    padding: 1rem 0;
...
>
  ...
  />
    ...
    `}get renderPrimaryActions(){return this.primaryActions.length===0?m:(this.dropdownState==="close"&&(this.primaryColor=this.primaryActions[0].className),this.primaryActions.length===1?this.initialActionTemplate:p`
    ...
    `)}get renderSecondaryActions(){return this.secondaryActions.length?this.secondaryActions.map(e=>this.renderActionButton(e)):m}renderActionLink(e,t=!1){return p`<span class="${this.getDeviceType} ${e.className}">
      <a
...
`,Ki={browseExpired:"IABookReader:BrowsingHasExpired"},Z={iaButton:"min-height:3.5rem;cursor:pointer;color:white;border-radius:0.4rem;border:1px solid #c5d1df;padding:4px 8px;width:auto;user-select:none;",renew:"background:#194880;width:110px;",return:"background:#d9534f;width:120px;",loaderIcon:"display:inline-block;width:20px;height:20px;margin-top:2px;color:white;--activityIndicatorLoadingRingColor:#fff;--activityIndicatorLoadingDotColor:#fff;",refresh:"background:none;font-size:inherit;border:0;padding:0;color:#0000ee;cursor:pointer;text-decoration:underline"};class Zi extends _{static get properties(){return{userid:{type:String},identifier:{type:String},bookTitle:{type:String},lendingStatus:{type:Object},returnUrl:{type:String},width:{type:Number},bwbPurchaseUrl:{type:String},lendingBarPostInit:{type:Function,attribute:!1},barType:{type:String},sharedObserver:{attribute:!1},disableActionGroup:{type:Boolean},modal:{Object},tokenDelay:{type:Number},timerExecutionSeconds:{type:Number},localCache:{type:Object},loanRenewTimeConfig:{type:Object},loanRenewResult:{type:Object}}}constructor(){super(),this.userid="",this.identifier="",this.bookTitle="",this.returnUrl="",this.lendingStatus={},this.width=0,this.bwbPurchaseUrl="",this.lendingBarPostInit=()=>{},this.barType="action",this.sharedObserver=void 0,this.disableActionGroup=!1,this.tokenDelay=120,this.timerExecutionSeconds=30,this.postInitComplete=!1,this.primaryActions=[],this.primaryTitle="",this.primaryColor="primary",this.secondaryActions=[],this.lendingOptions={},this.borrowType=null,this.browseTimer=void 0,this.timeWhenTimerStart=void 0,this.loanRenewInProgress=!1,this.recoveringFromLoanExpiry=!1,this.warningModalOpen=!1,this.warningModalDismissed=!1,this.loanRenewTimeConfig={loanTotalTime:3600,loanRenewAtLast:660,pageChangedInLast:900},this.loanRenewResult={texts:"",renewNow:!1,secondsLeft:0,renewType:""}}disconnectedCallback(){var e;(e=window==null?void 0:window.IALendingIntervals)==null||e.clearAll(),this.sentryCaptureMsg(L.disconnectedCallback),this.disconnectResizeObserver()}sentryCaptureMsg(e){var t;(t=window==null?void 0:window.Sentry)==null||t.captureMessage(e)}firstUpdated(){this.bindLoanRenewEvents(),this.localCache=new bt({namespace:"loanRenew"}),this.sharedObserver||(this.sharedObserver=new Zt,this.setupResizeObserver())}updated(e){(e.has("lendingStatus")||e.has("bwbPurchaseUrl"))&&this.setupLendingToolbarActions(),e.has("sharedObserver")&&(this.disconnectResizeObserver(),this.setupResizeObserver()),e.has("loanRenewResult")&&this.loanRenewResult.renewNow&&(this.loanRenewInProgress=!0,window.IALendingIntervals.clearAll())}handleResize(e){const{target:t}=e;if(t!==this.shadowRoot.host)return;const{contentRect:i}=e;this.width=Math.round(i.width)}disconnectResizeObserver(){var e;(e=this.sharedObserver)==null||e.removeObserver({handler:this,target:this.shadowRoot.host})}setupResizeObserver(){var e;!this.shadowRoot||(e=this.sharedObserver)==null||e.addObserver({handler:this,target:this.shadowRoot.host})}async setupLendingToolbarActions(){var i,n,s,r;const e="browsingExpired"in this.lendingStatus&&((i=this.lendingStatus)==null?void 0:i.browsingExpired);if(e){b("[IABookActions] browsing expired \u2014 leaving action bar untouched"),this.tokenPoller||this.sentryCaptureMsg(L.bookWasExpired),(n=window==null?void 0:window.IALendingIntervals)==null||n.clearAll(),this.dispatchEvent(new Event(Ki.browseExpired,{bubbles:!0,cancelable:!1,composed:!0}));return}this.lendingOptions=new Wi(this.userid,this.identifier,this.lendingStatus,this.bwbPurchaseUrl);const t=this.lendingOptions.getCurrentLendingActions();if(!!t){if(this.primaryTitle=t.primaryTitle,this.primaryActions=(s=t.primaryActions)==null?void 0:s.filter(l=>l!=null),this.primaryColor=t.primaryColor,this.secondaryActions=(r=t.secondaryActions)==null?void 0:r.filter(l=>l!=null),this.borrowType=t.borrowType?t.borrowType:null,this.borrowType==="browsed"&&(await this.startTimerCountdown(),await this.startBrowseTimer()),!this.borrowType||this.barType==="title"){this.lendingBarPostInit();return}setTimeout(()=>{!e&&!this.loanRenewInProgress&&!window.IALendingIntervals.tokenPoller&&this.startLoanTokenPoller()},100),this.requestUpdate()}}bindLoanRenewEvents(){window.addEventListener("BookReader:userAction",()=>{const e=this.lendingStatus.browsingExpired;b("[IABookActions] BookReader:userAction received",{borrowType:this.borrowType,browsingExpired:e}),e&&this.autoRenewExpiredLoan(),this.borrowType==="browsed"&&!e&&this.autoLoanRenewChecker(!0)}),document.addEventListener("visibilitychange",async()=>{if(document.hidden){b("[IABookActions] visibilitychange: tab backgrounded");return}b("[IABookActions] visibilitychange: tab foregrounded",this.borrowType);try{if(this.lendingStatus.browsingExpired===!0){this.autoRenewExpiredLoan();return}if(this.borrowType!=="browsed")return;if(this.lendingStatus.browsingExpired===!1){const e=await this.localCache.get(`${this.identifier}-loanTime`),t=Math.round((e-new Date)/1e3);t>=this.timerExecutionSeconds?this.loanStatusCheckInterval(Number(t)):(this.autoRenewExpiredLoan(),this.disconnectedCallback())}}catch(e){b("[IABookActions] visibilitychange handler failed",e),this.sentryCaptureMsg(`visibilitychange handler failed: ${e}`)}})}async autoLoanRenewChecker(e=!1){this.loanRenewHelper=new Gi(e,this.identifier,this.localCache,this.loanRenewTimeConfig),await this.loanRenewHelper.handleLoanRenew(),this.loanRenewResult=this.loanRenewHelper.result}autoRenewExpiredLoan(){var e;this.loanRenewInProgress||(this.loanRenewInProgress=!0,this.recoveringFromLoanExpiry=!0,(e=this.modal)==null||e.closeModal(),this.lendingStatus={...this.lendingStatus,browsingExpired:!1,secondsLeftOnLoan:this.loanRenewTimeConfig.loanTotalTime},setTimeout(()=>{this.loanRenewResult={texts:"",renewNow:!0,renewType:"auto"}},0))}get modal(){const e=document.body.querySelector("modal-manager");return e==null||e.setAttribute("id","action-bar-modal"),e}async showWarningModal(){var r,l,a;if(this.warningModalOpen)return;this.warningModalOpen=!0,b("[IABookActions] showWarningModal");const{texts:e,secondsLeft:t}=this.loanRenewResult;let i=t;i===void 0||i<=0?i=this.lendingStatus.secondsLeftOnLoan:i=i>60?i:60,this.modal.customModalContent=m,(r=this.modal)==null||r.closeModal(),this.loanRenewResult={texts:"",renewNow:!1};const n=new z({headline:"Are you still there?",headerColor:"#194880",showCloseButton:!1,closeOnBackdropClick:!1,message:p`<span
    ...
    ></book-title-bar>`}get timerCountdownEl(){return this.shadowRoot.querySelector("timer-countdown")}get bookActionBar(){return p`
      ...
      ></timer-countdown>
    `}async handleLoanAutoRenewed({detail:e}){var n,s,r;const t=(n=e==null?void 0:e.data)==null?void 0:n.loan,i=`Whoops, seems we hit a hiccup with renewing this book. Please refresh & retry. --- (Debug: ${(s=e==null?void 0:e.data)==null?void 0:s.error})`;if(!t){this.recoveringFromLoanExpiry=!1,this.showErrorModal(i,"handleLoanAutoRenewed");return}if(this.loanRenewResult.renewNow){const l=await this.localCache.get(`${this.identifier}-loanTime`),a=Math.round((l-new Date)/1e3),c=Number.isFinite(a)&&a>0?a:this.loanRenewTimeConfig.loanTotalTime;b("[IABookActions] handleLoanAutoRenewed",{secondsLeft:c,rawSecondsLeft:a,ajaxResponse:e==null?void 0:e.data}),this.recoveringFromLoanExpiry&&(this.postInitComplete=!1,this.recoveringFromLoanExpiry=!1);const h={...this.lendingStatus,user_has_browsed:!0,browsingExpired:!1,secondsLeftOnLoan:c};this.lendingStatus=h,(r=this.modal)==null||r.closeModal(),this.modal.removeAttribute("id"),this.modal.customModalContent=m,this.sentryCaptureMsg(L.bookHasRenewed),this.warningModalDismissed=!1}this.warningModalOpen=!1,this.loanRenewInProgress=!1}async startTimerCountdown(){var t;(t=window==null?void 0:window.IALendingIntervals)==null||t.clearTimerCountdown();const e=Number(this.lendingStatus.secondsLeftOnLoan);this.timeWhenTimerStart=new Date,window.IALendingIntervals.timerCountdown=setInterval(async()=>{await this.loanStatusCheckInterval(e)},this.timerExecutionSeconds*1e3)}async loanStatusCheckInterval(e){let t=e;t-=this.timerExecutionSeconds,t=Math.round(t);const i=this.reSyncTimerIfGoneOff(t);i.hasSynced&&(t=i.whatShouldLeft,b("[IABookActions] timer: timer re-synced",{secondsLeft:t})),b("[IABookActions] timer",{secondsLeft:t,loanRenewAtLast:this.loanRenewTimeConfig.loanRenewAtLast,pageChangedInLast:this.loanRenewTimeConfig.pageChangedInLast}),t<=this.loanRenewTimeConfig.loanRenewAtLast&&await this.loanRenewAttempt(t),t<=this.timerExecutionSeconds&&(this.disconnectedCallback(),this.sentryCaptureMsg(L.clearOneHourTimer))}reSyncTimerIfGoneOff(e){const i=new Date().getTime()/1e3-this.timeWhenTimerStart.getTime()/1e3,n=this.lendingStatus.secondsLeftOnLoan-i,s=Math.round(e),r=Math.round(n);if((this.timerCountdownEl.secondsLeftOnLoan||0)!==r||s!==r){const a={...this.lendingStatus,secondsLeftOnLoan:r};this.lendingStatus=a}return s!==r?(b(`[IABookActions] reSyncTimerIfGoneOff ${s} - ${r}: re-syncing timer`),{hasSynced:!0,whatShouldLeft:r}):{hasSynced:!1,whatShouldLeft:r}}async loanRenewAttempt(e){let t=e;if(t<50){b("[IABookActions] loanRenewAttempt: < 50s left, expiring loan"),await this.browseHasExpired();return}await this.autoLoanRenewChecker(!1),this.loanRenewResult.renewNow===!1&&!this.warningModalDismissed&&(t-=60,this.loanRenewResult.secondsLeft=t,this.showWarningModal())}startLoanTokenPoller(){const e=()=>{this.postInitComplete||this.lendingBarPostInit(),this.postInitComplete=!0},t=i=>{this.handleLendingActionError(i)};this.tokenPoller=new ji(this.identifier,this.borrowType,e,t,this.tokenDelay)}handleToggleActionGroup(){this.disableActionGroup=!this.disableActionGroup}handleLendingActionError(e){var n,s,r,l,a;this.disableActionGroup=!1;const t=(n=e==null?void 0:e.detail)==null?void 0:n.action,i=(r=(s=e==null?void 0:e.detail)==null?void 0:s.data)==null?void 0:r.error;if(t==="create_token"?(l=window==null?void 0:window.IALendingIntervals)==null||l.clearTokenPoller():(a=window==null?void 0:window.IALendingIntervals)==null||a.clearAll(),t==="renew_loan"&&(this.loanRenewInProgress=!1,this.recoveringFromLoanExpiry=!1),i&&t==="renew_loan"&&i.match(/not available/)?this.showLoanUnavailableModal():i&&t!=="create_token"&&this.showErrorModal(i,t),t==="create_token"){const c={...this.lendingStatus,user_has_browsed:!1,available_to_browse:!0};this.lendingStatus=c}if(i&&i.match(/not available to borrow/gm)){let c=this.lendingStatus;t==="browse_book"?c={...this.lendingStatus,available_to_browse:!1}:t==="borrow_book"&&(c={...this.lendingStatus,available_to_borrow:!1}),this.lendingStatus=c}}async showErrorModal(e,t){var n;const i=new z({title:"Lending error",message:e,headerColor:"#d9534f",showCloseButton:!0});if(t==="create_token"){const s=p`<button
        style="${Z.refresh}"
