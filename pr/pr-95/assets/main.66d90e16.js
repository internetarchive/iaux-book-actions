 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=globalThis,ze=o=>o,ce=J.trustedTypes,Fe=ce?ce.createPolicy("lit-html",{createHTML:o=>o}):void 0,ht="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,ut="?"+$,Dt=`<${ut}>`,O=document,Y=()=>O.createComment(""),X=o=>o===null||typeof o!="object"&&typeof o!="function",Re=Array.isArray,Ht=o=>Re(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",fe=`[ 	
\f\r]`,G=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,We=/-->/g,je=/>/g,B=RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),qe=/'/g,Ge=/"/g,gt=/^(?:script|style|textarea|title)$/i,pt=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),g=pt(1),Ut=pt(2),E=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),Ke=new WeakMap,I=O.createTreeWalker(O,129);function ft(o,e){if(!Re(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return Fe!==void 0?Fe.createHTML(e):e}const zt=(o,e)=>{const t=o.length-1,i=[];let n,s=e===2?"<svg>":e===3?"<math>":"",r=G;for(let l=0;l<t;l++){const a=o[l];let c,h,f=-1,w=0;for(;w<a.length&&(r.lastIndex=w,h=r.exec(a),h!==null);)w=r.lastIndex,r===G?h[1]==="!--"?r=We:h[1]!==void 0?r=je:h[2]!==void 0?(gt.test(h[2])&&(n=RegExp("</"+h[2],"g")),r=B):h[3]!==void 0&&(r=B):r===B?h[0]===">"?(r=n!=null?n:G,f=-1):h[1]===void 0?f=-2:(f=r.lastIndex-h[2].length,c=h[1],r=h[3]===void 0?B:h[3]==='"'?Ge:qe):r===Ge||r===qe?r=B:r===We||r===je?r=G:(r=B,n=void 0);const y=r===B&&o[l+1].startsWith("/>")?" ":"";s+=r===G?a+Dt:f>=0?(i.push(c),a.slice(0,f)+ht+a.slice(f)+$+y):a+$+(f===-2?l:y)}return[ft(o,s+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class Q{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let s=0,r=0;const l=e.length-1,a=this.parts,[c,h]=zt(e,t);if(this.el=Q.createElement(c,i),I.currentNode=this.el.content,t===2||t===3){const f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(n=I.nextNode())!==null&&a.length<l;){if(n.nodeType===1){if(n.hasAttributes())for(const f of n.getAttributeNames())if(f.endsWith(ht)){const w=h[r++],y=n.getAttribute(f).split($),C=/([.?@])?(.*)/.exec(w);a.push({type:1,index:s,name:C[2],strings:y,ctor:C[1]==="."?Wt:C[1]==="?"?jt:C[1]==="@"?qt:de}),n.removeAttribute(f)}else f.startsWith($)&&(a.push({type:6,index:s}),n.removeAttribute(f));if(gt.test(n.tagName)){const f=n.textContent.split($),w=f.length-1;if(w>0){n.textContent=ce?ce.emptyScript:"";for(let y=0;y<w;y++)n.append(f[y],Y()),I.nextNode(),a.push({type:2,index:++s});n.append(f[w],Y())}}}else if(n.nodeType===8)if(n.data===ut)a.push({type:2,index:s});else{let f=-1;for(;(f=n.data.indexOf($,f+1))!==-1;)a.push({type:7,index:s}),f+=$.length-1}s++}}static createElement(e,t){const i=O.createElement("template");return i.innerHTML=e,i}}function W(o,e,t=o,i){var r,l,a;if(e===E)return e;let n=i!==void 0?(r=t._$Co)==null?void 0:r[i]:t._$Cl;const s=X(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==s&&((l=n==null?void 0:n._$AO)==null||l.call(n,!1),s===void 0?n=void 0:(n=new s(o),n._$AT(o,t,i)),i!==void 0?((a=t._$Co)!=null?a:t._$Co=[])[i]=n:t._$Cl=n),n!==void 0&&(e=W(o,n._$AS(o,e.values),n,i)),e}class Ft{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var c;const{el:{content:t},parts:i}=this._$AD,n=((c=e==null?void 0:e.creationScope)!=null?c:O).importNode(t,!0);I.currentNode=n;let s=I.nextNode(),r=0,l=0,a=i[0];for(;a!==void 0;){if(r===a.index){let h;a.type===2?h=new ee(s,s.nextSibling,this,e):a.type===1?h=new a.ctor(s,a.name,a.strings,this,e):a.type===6&&(h=new Gt(s,this,e)),this._$AV.push(h),a=i[++l]}r!==(a==null?void 0:a.index)&&(s=I.nextNode(),r++)}return I.currentNode=O,n}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ee{get _$AU(){var e,t;return(t=(e=this._$AM)==null?void 0:e._$AU)!=null?t:this._$Cv}constructor(e,t,i,n){var s;this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=(s=n==null?void 0:n.isConnected)!=null?s:!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=W(this,e,t),X(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==E&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ht(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&X(this._$AH)?this._$AA.nextSibling.data=e:this.T(O.createTextNode(e)),this._$AH=e}$(e){var s;const{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=Q.createElement(ft(i.h,i.h[0]),this.options)),i);if(((s=this._$AH)==null?void 0:s._$AD)===n)this._$AH.p(t);else{const r=new Ft(n,this),l=r.u(this.options);r.p(t),this.T(l),this._$AH=r}}_$AC(e){let t=Ke.get(e.strings);return t===void 0&&Ke.set(e.strings,t=new Q(e)),t}k(e){Re(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,n=0;for(const s of e)n===t.length?t.push(i=new ee(this.O(Y()),this.O(Y()),this,this.options)):i=t[n],i._$AI(s),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e!==this._$AB;){const n=ze(e).nextSibling;ze(e).remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class de{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,s){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=m}_$AI(e,t=this,i,n){const s=this.strings;let r=!1;if(s===void 0)e=W(this,e,t,0),r=!X(e)||e!==this._$AH&&e!==E,r&&(this._$AH=e);else{const l=e;let a,c;for(e=s[0],a=0;a<s.length-1;a++)c=W(this,l[i+a],t,a),c===E&&(c=this._$AH[a]),r||(r=!X(c)||c!==this._$AH[a]),c===m?e=m:e!==m&&(e+=(c!=null?c:"")+s[a+1]),this._$AH[a]=c}r&&!n&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Wt extends de{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class jt extends de{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class qt extends de{constructor(e,t,i,n,s){super(e,t,i,n,s),this.type=5}_$AI(e,t=this){var r;if((e=(r=W(this,e,t,0))!=null?r:m)===E)return;const i=this._$AH,n=e===m&&i!==m||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==m&&(i===m||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)==null?void 0:t.host)!=null?i:this.element,e):this._$AH.handleEvent(e)}}class Gt{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){W(this,e)}}const we=J.litHtmlPolyfillSupport;var at;we==null||we(Q,ee),((at=J.litHtmlVersions)!=null?at:J.litHtmlVersions=[]).push("3.3.3");const Kt=(o,e,t)=>{var s,r;const i=(s=t==null?void 0:t.renderBefore)!=null?s:e;let n=i._$litPart$;if(n===void 0){const l=(r=t==null?void 0:t.renderBefore)!=null?r:null;i._$litPart$=n=new ee(e.insertBefore(Y(),l),l,void 0,t!=null?t:{})}return n._$AI(o),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P=globalThis;class _ extends U{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,i;const e=super.createRenderRoot();return(i=(t=this.renderOptions).renderBefore)!=null||(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Kt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return E}}var lt;_._$litElement$=!0,_.finalized=!0,(lt=P.litElementHydrateSupport)==null||lt.call(P,{LitElement:_});const me=P.litElementPolyfillSupport;me==null||me({LitElement:_});var ct;((ct=P.litElementVersions)!=null?ct:P.litElementVersions=[]).push("4.2.2");class Zt{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(n=>{n.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}class z{constructor(e){var t,i,n,s,r,l,a,c,h;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!=null?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!=null?i:"#fbfbfd",this.showProcessingIndicator=(n=e==null?void 0:e.showProcessingIndicator)!=null?n:!1,this.processingImageMode=(s=e==null?void 0:e.processingImageMode)!=null?s:"complete",this.showCloseButton=(r=e==null?void 0:e.showCloseButton)!=null?r:!0,this.showLeftNavButton=(l=e==null?void 0:e.showLeftNavButton)!=null?l:!1,this.leftNavButtonText=(a=e==null?void 0:e.leftNavButtonText)!=null?a:"",this.showHeaderLogo=(c=e==null?void 0:e.showHeaderLogo)!=null?c:!0,this.closeOnBackdropClick=(h=e==null?void 0:e.closeOnBackdropClick)!=null?h:!0}}/*! *****************************************************************************
 ...
 */function Yt(o,e){return(t,i,n)=>{const s=r=>{var l,a;return(a=(l=r.renderRoot)==null?void 0:l.querySelector(o))!=null?a:null};if(e){const{get:r,set:l}=typeof i=="object"?t:n!=null?n:(()=>{const a=Symbol();return{get(){return this[a]},set(c){this[a]=c}}})();return Ze(t,i,{get(){let a=r.call(this);return a===void 0&&(a=s(this),(a!==null||this.hasUpdated)&&l.call(this,a)),a}})}return Ze(t,i,{get(){return s(this)}})}}function*Pe(o=document.activeElement){o!=null&&(yield o,"shadowRoot"in o&&o.shadowRoot&&o.shadowRoot.mode!=="closed"&&(yield*Pe(o.shadowRoot.activeElement)))}function wt(){return[...Pe()].pop()}const Ve=new WeakMap;function mt(o){let e=Ve.get(o);return e||(e=window.getComputedStyle(o,null),Ve.set(o,e)),e}function Xt(o){if("checkVisibility"in o&&typeof o.checkVisibility=="function")return o.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=mt(o);return e.visibility!=="hidden"&&e.display!=="none"}function Qt(o){const e=mt(o),{overflowY:t,overflowX:i}=e;return t==="scroll"||i==="scroll"?!0:t!=="auto"||i!=="auto"?!1:o.scrollHeight>o.clientHeight&&t==="auto"||o.scrollWidth>o.clientWidth&&i==="auto"}function ei(o){const e=o.tagName.toLowerCase(),t=Number(o.getAttribute("tabindex"));return o.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||o.hasAttribute("disabled")||o.closest("[inert]")||e==="input"&&o.getAttribute("type")==="radio"&&!o.hasAttribute("checked")||!Xt(o)?!1:(e==="audio"||e==="video")&&o.hasAttribute("controls")||o.hasAttribute("tabindex")||o.hasAttribute("contenteditable")&&o.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Qt(o)}function ti(o,e){var t;return((t=o.getRootNode({composed:!0}))==null?void 0:t.host)!==e}function Je(o){const e=new WeakMap,t=[];function i(n){if(n instanceof Element){if(n.hasAttribute("inert")||n.closest("[inert]")||e.has(n))return;e.set(n,!0),!t.includes(n)&&ei(n)&&t.push(n),n instanceof HTMLSlotElement&&ti(n,o)&&n.assignedElements({flatten:!0}).forEach(s=>{i(s)}),n.shadowRoot!==null&&n.shadowRoot.mode==="open"&&i(n.shadowRoot)}for(const s of Array.from(n.children))i(s)}return i(o),t.sort((n,s)=>{const r=Number(n.getAttribute("tabindex"))||0;return(Number(s.getAttribute("tabindex"))||0)-r})}let K=[];class ii{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{!this.isActive()||this.checkFocus()},this.handleKeyDown=t=>{var l;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const i=wt();if(this.previousFocus=i,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const n=Je(this.element);let s=n.findIndex(a=>a===i);this.previousFocus=this.currentFocus;const r=this.tabDirection==="forward"?1:-1;for(;;){s+r>=n.length?s=0:s+r<0?s=n.length-1:s+=r,this.previousFocus=this.currentFocus;const a=n[s];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||a&&this.possiblyHasTabbableChildren(a))return;t.preventDefault(),this.currentFocus=a,(l=this.currentFocus)==null||l.focus({preventScroll:!1});const c=[...Pe()];if(c.includes(this.currentFocus)||!c.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){K.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){K=K.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return K[K.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Je(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],n=this.tabDirection==="forward"?t:i;typeof(n==null?void 0:n.focus)=="function"&&(this.currentFocus=n,n.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}var Ye;(function(o){o.processing="processing",o.complete="complete"})(Ye||(Ye={}));let Le=class extends _{constructor(){super(...arguments),this.mode="processing"}render(){return g`
    ...
    `}};k([te({type:String})],Le.prototype,"mode",void 0);Le=k([Ie("ia-activity-indicator")],Le);var ni=g`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class oi extends _{static get styles(){return d`
    ...
    `}render(){return ni}}customElements.define("ia-icon-close",oi);var si=g`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let ke=class extends _{constructor(){super(...arguments),this.config=new z}render(){return g`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showLeftNavButton?this.leftNavButtonTemplate:m}
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?g`<div class="logo-icon">${si}</div>`:m}
    ...
    `}};k([te({type:Object})],ke.prototype,"config",void 0);ke=k([Ie("modal-template")],ke);function ai(o,e,t){var i=t||{},n=i.noTrailing,s=n===void 0?!1:n,r=i.noLeading,l=r===void 0?!1:r,a=i.debounceMode,c=a===void 0?void 0:a,h,f=!1,w=0;function y(){h&&clearTimeout(h)}function C(N){var D=N||{},S=D.upcomingOnly,ge=S===void 0?!1:S;y(),f=!ge}function ie(){for(var N=arguments.length,D=new Array(N),S=0;S<N;S++)D[S]=arguments[S];var ge=this,Me=Date.now()-w;if(f)return;function ne(){w=Date.now(),e.apply(ge,D)}function Oe(){h=void 0}!l&&c&&!h&&ne(),y(),c===void 0&&Me>o?l?(w=Date.now(),s||(h=setTimeout(c?Oe:ne,o))):ne():s!==!0&&(h=setTimeout(c?Oe:ne,c===void 0?o-Me:o))}return ie.cancel=C,ie}var T;(function(o){o.Open="open",o.Closed="closed"})(T||(T={}));class li{constructor(e){this.windowResizeThrottler=ai(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case T.Open:this.startResizeListener(),this.stopDocumentScroll();break;case T.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let j=class extends _{constructor(){super(...arguments),this.mode=T.Closed,this.hostBridge=new li(this),this.modal=new ii(this),this.closeOnBackdropClick=!0}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return g`
      <div class="container">
...
>
  ...
  />
    ...
    `}get renderPrimaryActions(){return this.primaryActions.length===0?m:(this.dropdownState==="close"&&(this.primaryColor=this.primaryActions[0].className),this.primaryActions.length===1?this.initialActionTemplate:g`
    ...
    `)}get renderSecondaryActions(){return this.secondaryActions.length?this.secondaryActions.map(e=>this.renderActionButton(e)):m}renderActionLink(e,t=!1){return g`<span class="${this.getDeviceType} ${e.className}">
      <a
...
`;class Mi extends Ct{static get properties(){return{identifier:{type:String},bookTitle:{type:String}}}constructor(){super(),this.identifier="",this.bookTitle="",this.analyticsCategories=M,this.analyticsActions=F}clickHandler(){const{category:e,action:t}={category:this.analyticsCategories.bookReaderHeader,action:this.analyticsActions.titleBar};this.dispatchEvent(new CustomEvent("bookTitleBar",{detail:{event:{category:e,action:t}}}))}render(){return g`
    ...
    `}}window.customElements.define("book-title-bar",Mi);class Oi extends _{static get properties(){return{texts:{type:String},textClass:{type:String}}}constructor(){super(),this.texts="",this.textClass=""}render(){return g`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class $e extends At{constructor(e){if(super(e),this.it=m,e.type!==yt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===m||e==null)return this._t=void 0,this.it=e;if(e===E)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}$e.directiveName="unsafeHTML",$e.resultType=1;const Ni=vt($e);var Di=g`
...
`;class Hi extends _{static get styles(){return d`
    ...
    `}render(){return Di}}customElements.define("ia-icon-info",Hi);class Ui extends _{static get properties(){return{iconClass:{type:String}}}constructor(){super(),this.iconClass="",this.helpURL="https://help.archive.org/help/borrowing-from-the-lending-library"}render(){return g`
      <a
...
`,Ki={browseExpired:"IABookReader:BrowsingHasExpired"},Z={iaButton:"min-height:3.5rem;cursor:pointer;color:white;border-radius:0.4rem;border:1px solid #c5d1df;padding:4px 8px;width:auto;user-select:none;",renew:"background:#194880;width:110px;",return:"background:#d9534f;width:120px;",loaderIcon:"display:inline-block;width:20px;height:20px;margin-top:2px;color:white;--activityIndicatorLoadingRingColor:#fff;--activityIndicatorLoadingDotColor:#fff;",refresh:"background:none;font-size:inherit;border:0;padding:0;color:#0000ee;cursor:pointer;text-decoration:underline"};class Zi extends _{static get properties(){return{userid:{type:String},identifier:{type:String},bookTitle:{type:String},lendingStatus:{type:Object},returnUrl:{type:String},width:{type:Number},bwbPurchaseUrl:{type:String},lendingBarPostInit:{type:Function,attribute:!1},barType:{type:String},sharedObserver:{attribute:!1},disableActionGroup:{type:Boolean},modal:{Object},tokenDelay:{type:Number},timerExecutionSeconds:{type:Number},localCache:{type:Object},loanRenewTimeConfig:{type:Object},loanRenewResult:{type:Object}}}constructor(){super(),this.userid="",this.identifier="",this.bookTitle="",this.returnUrl="",this.lendingStatus={},this.width=0,this.bwbPurchaseUrl="",this.lendingBarPostInit=()=>{},this.barType="action",this.sharedObserver=void 0,this.disableActionGroup=!1,this.tokenDelay=120,this.timerExecutionSeconds=30,this.postInitComplete=!1,this.primaryActions=[],this.primaryTitle="",this.primaryColor="primary",this.secondaryActions=[],this.lendingOptions={},this.borrowType=null,this.browseTimer=void 0,this.timeWhenTimerStart=void 0,this.loanRenewInProgress=!1,this.warningModalOpen=!1,this.warningModalDismissed=!1,this.loanRenewTimeConfig={loanTotalTime:3600,loanRenewAtLast:660,pageChangedInLast:900},this.loanRenewResult={texts:"",renewNow:!1,secondsLeft:0,renewType:""}}disconnectedCallback(){var e;(e=window==null?void 0:window.IALendingIntervals)==null||e.clearAll(),this.sentryCaptureMsg(L.disconnectedCallback),this.disconnectResizeObserver()}sentryCaptureMsg(e){var t;(t=window==null?void 0:window.Sentry)==null||t.captureMessage(e)}firstUpdated(){this.bindLoanRenewEvents(),this.localCache=new bt({namespace:"loanRenew"}),this.sharedObserver||(this.sharedObserver=new Zt,this.setupResizeObserver())}updated(e){(e.has("lendingStatus")||e.has("bwbPurchaseUrl"))&&this.setupLendingToolbarActions(),e.has("sharedObserver")&&(this.disconnectResizeObserver(),this.setupResizeObserver()),e.has("loanRenewResult")&&this.loanRenewResult.renewNow&&window.IALendingIntervals.clearAll()}handleResize(e){const{target:t}=e;if(t!==this.shadowRoot.host)return;const{contentRect:i}=e;this.width=Math.round(i.width)}disconnectResizeObserver(){var e;(e=this.sharedObserver)==null||e.removeObserver({handler:this,target:this.shadowRoot.host})}setupResizeObserver(){var e;!this.shadowRoot||(e=this.sharedObserver)==null||e.addObserver({handler:this,target:this.shadowRoot.host})}async setupLendingToolbarActions(){var i,n,s,r;this.lendingOptions=new Wi(this.userid,this.identifier,this.lendingStatus,this.bwbPurchaseUrl);const e=this.lendingOptions.getCurrentLendingActions();if(!e)return;this.primaryTitle=e.primaryTitle,this.primaryActions=(i=e.primaryActions)==null?void 0:i.filter(l=>l!=null),this.primaryColor=e.primaryColor,this.secondaryActions=(n=e.secondaryActions)==null?void 0:n.filter(l=>l!=null),this.borrowType=e.borrowType?e.borrowType:null;const t="browsingExpired"in this.lendingStatus&&((s=this.lendingStatus)==null?void 0:s.browsingExpired);if(t){b("[IABookActions] browsing expired \u2014 showing expired state"),this.tokenPoller||this.sentryCaptureMsg(L.bookWasExpired),(r=window==null?void 0:window.IALendingIntervals)==null||r.clearAll(),this.dispatchEvent(new Event(Ki.browseExpired,{bubbles:!0,cancelable:!1,composed:!0}));return}if(this.borrowType==="browsed"&&(await this.startTimerCountdown(),await this.startBrowseTimer()),!this.borrowType||this.barType==="title"){this.lendingBarPostInit();return}setTimeout(()=>{!t&&!window.IALendingIntervals.tokenPoller&&this.startLoanTokenPoller()},100),this.requestUpdate()}bindLoanRenewEvents(){window.addEventListener("BookReader:userAction",()=>{this.lendingStatus.browsingExpired&&this.autoRenewExpiredLoan(),this.borrowType==="browsed"&&this.autoLoanRenewChecker(!0)}),document.addEventListener("visibilitychange",async()=>{if(!document.hidden){if(b("[IABookActions] visibilitychange:",this.borrowType),this.lendingStatus.browsingExpired===!0){this.autoRenewExpiredLoan();return}if(this.borrowType!=="browsed")return;if(this.lendingStatus.browsingExpired===!1){const e=await this.localCache.get(`${this.identifier}-loanTime`),t=Math.round((e-new Date)/1e3);t>=this.timerExecutionSeconds?this.loanStatusCheckInterval(Number(t)):(this.autoRenewExpiredLoan(),this.disconnectedCallback())}}})}async autoLoanRenewChecker(e=!1){this.loanRenewHelper=new qi(e,this.identifier,this.localCache,this.loanRenewTimeConfig),await this.loanRenewHelper.handleLoanRenew(),this.loanRenewResult=this.loanRenewHelper.result}autoRenewExpiredLoan(){var e;this.loanRenewInProgress||(this.loanRenewInProgress=!0,(e=this.modal)==null||e.closeModal(),this.lendingStatus={...this.lendingStatus,browsingExpired:!1,secondsLeftOnLoan:this.loanRenewTimeConfig.loanTotalTime},setTimeout(()=>{this.loanRenewResult={texts:"",renewNow:!0,renewType:"auto"}},0))}get modal(){const e=document.body.querySelector("modal-manager");return e==null||e.setAttribute("id","action-bar-modal"),e}async showWarningModal(){var r,l,a;if(this.warningModalOpen)return;this.warningModalOpen=!0,b("[IABookActions] showWarningModal");const{texts:e,secondsLeft:t}=this.loanRenewResult;let i=t;i===void 0||i<=0?i=this.lendingStatus.secondsLeftOnLoan:i=i>60?i:60,this.modal.customModalContent=m,(r=this.modal)==null||r.closeModal(),this.loanRenewResult={texts:"",renewNow:!1};const n=new z({headline:"Are you still there?",headerColor:"#194880",showCloseButton:!1,closeOnBackdropClick:!1,message:g`${(l=this.loanRenewHelper)==null?void 0:l.getMessageTexts(e,i)}
    ...
    ></book-title-bar>`}get timerCountdownEl(){return this.shadowRoot.querySelector("timer-countdown")}get bookActionBar(){return g`
      ...
      ></timer-countdown>
    `}async handleLoanAutoRenewed({detail:e}){var n,s,r;const t=(n=e==null?void 0:e.data)==null?void 0:n.loan,i=`Whoops, seems we hit a hiccup with renewing this book. Please refresh & retry. --- (Debug: ${(s=e==null?void 0:e.data)==null?void 0:s.error})`;if(!t){this.showErrorModal(i,"handleLoanAutoRenewed");return}if(this.loanRenewResult.renewNow){const l=await this.localCache.get(`${this.identifier}-loanTime`),a=Math.round((l-new Date)/1e3);b("[IABookActions] handleLoanAutoRenewed",{secondsLeft:a,ajaxResponse:e==null?void 0:e.data});const c={...this.lendingStatus,user_has_browsed:!0,browsingExpired:!1,secondsLeftOnLoan:a};this.lendingStatus=c,(r=this.modal)==null||r.closeModal(),this.modal.removeAttribute("id"),this.modal.customModalContent=m,this.sentryCaptureMsg(L.bookHasRenewed),this.warningModalDismissed=!1}this.warningModalOpen=!1,this.loanRenewInProgress=!1}async startTimerCountdown(){var t;(t=window==null?void 0:window.IALendingIntervals)==null||t.clearTimerCountdown();const e=Number(this.lendingStatus.secondsLeftOnLoan);this.timeWhenTimerStart=new Date,window.IALendingIntervals.timerCountdown=setInterval(async()=>{await this.loanStatusCheckInterval(e)},this.timerExecutionSeconds*1e3)}async loanStatusCheckInterval(e){let t=e;t-=this.timerExecutionSeconds,t=Math.round(t);const i=this.reSyncTimerIfGoneOff(t);i.hasSynced&&(t=i.whatShouldLeft,b("[IABookActions] startTimerCountdown: timer re-synced",{secondsLeft:t})),b("[IABookActions] startTimerCountdown",{secondsLeft:t,loanRenewAtLast:this.loanRenewTimeConfig.loanRenewAtLast}),t<=this.loanRenewTimeConfig.loanRenewAtLast&&await this.loanRenewAttempt(t),t<=this.timerExecutionSeconds&&(this.disconnectedCallback(),this.sentryCaptureMsg(L.clearOneHourTimer))}reSyncTimerIfGoneOff(e){const i=new Date().getTime()/1e3-this.timeWhenTimerStart.getTime()/1e3,n=this.lendingStatus.secondsLeftOnLoan-i,s=Math.round(e),r=Math.round(n);if((this.timerCountdownEl.secondsLeftOnLoan||0)!==r||s!==r){const a={...this.lendingStatus,secondsLeftOnLoan:r};this.lendingStatus=a}return s!==r?(b(`[IABookActions] reSyncTimerIfGoneOff ${s} - ${r}: re-syncing timer`),{hasSynced:!0,whatShouldLeft:r}):{hasSynced:!1,whatShouldLeft:r}}async loanRenewAttempt(e){let t=e;if(t<50){b("[IABookActions] loanRenewAttempt: < 50s left, expiring loan"),await this.browseHasExpired();return}await this.autoLoanRenewChecker(!1),this.loanRenewResult.renewNow===!1&&!this.warningModalDismissed&&(t-=60,this.loanRenewResult.secondsLeft=t,this.showWarningModal())}startLoanTokenPoller(){const e=()=>{this.postInitComplete||this.lendingBarPostInit(),this.postInitComplete=!0},t=i=>{this.handleLendingActionError(i)};this.tokenPoller=new ji(this.identifier,this.borrowType,e,t,this.tokenDelay)}handleToggleActionGroup(){this.disableActionGroup=!this.disableActionGroup}handleLendingActionError(e){var n,s,r,l;this.disableActionGroup=!1,(n=window==null?void 0:window.IALendingIntervals)==null||n.clearAll();const t=(s=e==null?void 0:e.detail)==null?void 0:s.action,i=(l=(r=e==null?void 0:e.detail)==null?void 0:r.data)==null?void 0:l.error;if(i&&t==="renew_loan"&&i.match(/not available/)?(this.loanRenewInProgress=!1,this.showLoanUnavailableModal()):i&&t!=="create_token"&&this.showErrorModal(i,t),t==="create_token"){const a={...this.lendingStatus,user_has_browsed:!1,available_to_browse:!0};this.lendingStatus=a}if(i&&i.match(/not available to borrow/gm)){let a=this.lendingStatus;t==="browse_book"?a={...this.lendingStatus,available_to_browse:!1}:t==="borrow_book"&&(a={...this.lendingStatus,available_to_borrow:!1}),this.lendingStatus=a}}async showErrorModal(e,t){var n;const i=new z({title:"Lending error",message:e,headerColor:"#d9534f",showCloseButton:!0});if(t==="create_token"){const s=g`<button
        style="${Z.refresh}"
      ...
      >
        ...
        >
        </text-group>`:m}get hasAdminAccess(){return!this.lendingStatus.userHasBorrowed&&this.lendingStatus.isAdmin}static get styles(){return d`
      :host {
        display: block;
      }
