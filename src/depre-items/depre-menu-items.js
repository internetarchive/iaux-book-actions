...
// import { mobileContainerWidth } from './shared-components';
import {
...
export default class MenuItems {
  ...
  accessAdminOrPrintDisabled() {
    ...
    // return {
    //   actions: [],
    //   title: '<div class="BookReaderMessage">' +
    //     '<a href="' + backHref + '">' + message + '</a>' +
    //   '</div>'
    // };
  ...
  canBorrow1Hr() {
    ...
    var browsingHasExpired = (!lendingStatus.available_to_browse && lendingInfo.browsingExpired);
